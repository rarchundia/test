<?php
  $page_title = 'Constancia de Situacion Fiscal';
...
<div class="row">
   ...
   <form method="post"  class="dropzone" action="sube_documentos_ajax.php" id="form_constitutiva" enctype="multipart/form-data">
     ...
     <input type="hidden" name="empresa2" id="empresa2" value="<?php echo $id_varible; ?>" >
	<!--    <input type="text" name="empresa2" id="empresa2" value="<?php echo $id_varible; ?>" >
	-->  <br><br><br>
			</form>
			
			
			<a href="id_oficial.php?id=<?php echo (int)$id_varible; ?>" class="btn btn-primary" id="btn_siguiente">Siguiente</a>
    ...
    formData.append("empresa2", jQuery('#empresa2').val()); // attach dropzone image element
...
*/
    ...
    dictDefaultMessage: "Arrastra El Archivo Aqui o Da Click.<br>-Documento Situación Fiscal-",
			maxFilesize: 10, // MB
                maxFiles: 1,
			addRemoveLinks: true,
