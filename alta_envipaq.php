...
Puedes subir los archivos juntos  o uno por uno
   ...
   <form method="post"  class="dropzone" action="sube_documentos_ajax.php" id="form_constitutiva" enctype="multipart/form-data">
    <input type="hidden" name="correo" id="correo" value="<?php echo $user["email"]?>">
     ...
     <input type="hidden" name="empresa7" id="empresa7" value="<?php echo $id_varible; ?>" >
    ...
    formData.append("empresa7", jQuery('#empresa7').val()); // attach dropzone image element
...
*/
    ...
    dictDefaultMessage: "Arrastra El (Los) Archivo(s) Aqui o Da Click.<br>-Documento(s) Alta Envipaq-",
			maxFilesize: 10, // MB
                maxFiles: 2,
			addRemoveLinks: true,
