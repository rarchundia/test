...
$id=$_GET['id'];
 ...
 $sql   = " SELECT id,remitente, direccion, colonia, palet, razon_social, detalles, carga, venta, comer_venta, uva_venta, arance_venta, cp, nombre_destinatario, direccion_des, colonia_des, cp_des, telefono_des, correo, fecha, producto ";
 $sql  .= " FROM entrega";
...
<table border="0" class="tabla logo" cellpadding="3" cellspacing="0" >
  ...
  <tbody class="td">
    ...
    <br><tr class="tr">
      <td class="fondo td"><?php echo $columna['palet']; ?></td>
      <td class="td">Almacenado <?php echo $columna['carga']; ?> </td>
      <!--<td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
   ...
   <tr class="tr">
      ...
      <td class="fondo td" align="center">$ 
		...
		$total=$columna['arance_venta']+$columna['comer_venta']+$columna['venta']+$columna['uva_venta'];
