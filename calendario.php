...
$por_user = ultimas_citas_calendario($usuario)
/*}else{
				...
				$('#calendar').fullCalendar({
					...
					events: [
						<?php foreach ($resultado_eventos as  $registros_eventos): ?>
								...
								title: '<?php echo $registros_eventos['name']; ?>',
...
start: '<?php echo $registros_eventos['fecha_hora']." ".$registros_eventos['tiempo']; 
                        ...
                        <?php endforeach; ?><?php foreach ($por_user as  $registros_eventos): ?>
								{
								id: '<?php echo $registros_eventos['id_cita']; ?>',
								title: '<?php echo $registros_eventos['notas']; ?>',
                                    color: '<?php echo $registros_eventos['color']; ?>',
                                    contacto: '<?php echo $registros_eventos['contacto']; ?>',
                                  notas: '<?php echo $registros_eventos['notas'];?>',
 ...
 <div class="row">
  ...
  <div class="col-md-12">
    ...
    <!--<?php foreach ($resultado_eventos as  $registros_eventos): ?>
      ...
      <textarea class="form-control" name="titulo" rows="3" data-emojiable="true" data-emoji-input="unicode" onkeyup="mayus(this);" autofocus placeholder="Titulo do Evento" onkeyup="mayus(this);" required></textarea>
           </p>
