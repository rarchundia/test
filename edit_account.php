      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <div class="panel-heading clearfix">
            ...
            <span>Cambiar Foto de Mi Perfil</span>
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <div class="form-group">
                <input type="file" name="file_upload" id="file_upload" multiple="multiple" class="btn btn-default btn-file"/>
              </div>
              <div class="form-group">
                <input type="hidden" name="user_id" value="<?php echo $user['id'];?>">
                 <button type="submit" name="submit" id="subir" class="btn btn-info">Cambiar</button><br><br><br>
              </div>
             </form>
            </div>
          </div>
