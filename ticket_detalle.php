  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <!--class="dropzone"-->
          ...
          <div id="upload_proceso"></div>
		    ...
		    <form method="post"  class="dropzone" action="sube_documentos_ajax.php" id="form_ticket" enctype="multipart/form-data">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal" id="btn_siguiente">Cerrar</button>
      </div>
    </div>
	 ...
	 <?php 
		...
		<script>
			...
			Dropzone.options.form_ticket = {
  paramName: "file", // The name that will be used to transfer the file
  //maxFilesize: 2, // MB
 dictDefaultMessage: "put",
  accept: function(file, done) {
    if (file.name == "FileZilla_3.48.0_win64-setup.exe") {
      done("Naha, you don't.");
    }
    else { done(); }
  }
