...
if(isset($_POST['alta_envi'])) {
 
	
	if(empty($errors)){
         $p_id= remove_junk($db->escape($_POST['id_edit']));
		
		
          $sql = "UPDATE contacto SET alta_envi='2' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Validado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
			//redirect('edit_user.php?id='.(int)$e_user['id'], false);
        } else {
          $session->msg('d','Fallo al Validar El  Documento');
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
			//redirect('edit_user.php?id='.(int)$e_user['id'], false);
        }
  } else {
    $session->msg("d", $errors);
    redirect('detalle_documento.php?id='.(int)$p_id,false);
  }
}


if(isset($_POST['alta_envi_x'])) {
	...
	if(empty($errors)){
         ...
         $p_notas= remove_junk($db->escape($_POST['notas']));
          ...
          $sql = "UPDATE contacto SET alta_envi='3', alta_envi_notas='{$p_notas}' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Descartado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
			//redirect('edit_user.php?id='.(int)$e_user['id'], false);
        } else {
          $session->msg('d','Fallo al Descartar  el  Documento');
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
			//redirect('edit_user.php?id='.(int)$e_user['id'], false);
        }
  } else {
...
if(isset($_POST['alta_envi_excel'])) {
	...
	if(empty($errors)){
         $p_id= remove_junk($db->escape($_POST['id_edit']));
          ...
          $sql = "UPDATE contacto SET alta_envi_excel='2' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Validado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
...
if(isset($_POST['alta_envi_x_excel'])) {
	...
	if(empty($errors)){
		 ...
		 $p_notas= remove_junk($db->escape($_POST['notas']));
          $sql = "UPDATE contacto SET alta_envi_excel='3', alta_envi_excel_notas='{$p_notas}' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Descartado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
	...
	if(empty($errors)){
         $p_id= remove_junk($db->escape($_POST['id_edit']));
          ...
          $sql = "UPDATE contacto SET acta_constitutiva='2' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Validado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
...
if(isset($_POST['acta_constitutiva_x'])) {
	...
	if(empty($errors)){
		 ...
		 $p_notas= remove_junk($db->escape($_POST['notas']));
          ...
          $sql = "UPDATE contacto SET acta_constitutiva='3', acta_constitutiva_notas='{$p_notas}' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Descartado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
	...
	if(empty($errors)){
         $p_id= remove_junk($db->escape($_POST['id_edit']));
          ...
          $sql = "UPDATE contacto SET sit_fiscar='2' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Validado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
...
if(isset($_POST['sit_fiscar_x'])) {
	...
	if(empty($errors)){
		 ...
		 $p_notas= remove_junk($db->escape($_POST['notas']));
          $sql = "UPDATE contacto SET sit_fiscar='3', sit_fiscal_notas='{$p_notas}' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Descartado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
	...
	if(empty($errors)){
         $p_id= remove_junk($db->escape($_POST['id_edit']));
          ...
          $sql = "UPDATE contacto SET identificacion='2' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Validado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
...
if(isset($_POST['identificacion_x'])) {
	...
	if(empty($errors)){
		 ...
		 $p_notas= remove_junk($db->escape($_POST['notas']));
          ...
          $sql = "UPDATE contacto SET identificacion='3', identificacion_notas='{$p_notas}' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Descartado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
	...
	if(empty($errors)){
         $p_id= remove_junk($db->escape($_POST['id_edit']));
          ...
          $sql = "UPDATE contacto SET comp_domicilio='2' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Validado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
...
if(isset($_POST['comp_domicilio_x'])) {
	...
	if(empty($errors)){
		 ...
		 $p_notas= remove_junk($db->escape($_POST['notas']));
          $sql = "UPDATE contacto SET comp_domicilio='3', comp_domicilio_notas='{$p_notas}' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Descartado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
	...
	if(empty($errors)){
         $p_id= remove_junk($db->escape($_POST['id_edit']));
          ...
          $sql = "UPDATE contacto SET estado_cuenta='2' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Validado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
...
if(isset($_POST['estado_cuenta_x'])) {
	...
	if(empty($errors)){
		 ...
		 $p_notas= remove_junk($db->escape($_POST['notas']));
          $sql = "UPDATE contacto SET estado_cuenta='3', estado_cuenta_notas='{$p_notas}' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Descartado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
...
if(isset($_POST['preanalisis'])) {
	...
	if(empty($errors)){
         $p_id= remove_junk($db->escape($_POST['id_edit']));
          ...
          $sql = "UPDATE contacto SET preanalisis='2' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Validado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
...
if(isset($_POST['preanalisis_x'])) {
	...
	if(empty($errors)){
		 ...
		 $p_notas= remove_junk($db->escape($_POST['notas']));
          ...
          $sql = "UPDATE contacto SET preanalisis='3', preanalisis_notas='{$p_notas}' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Descartado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
...
if(isset($_POST['preanalisis_excel'])) {
	...
	if(empty($errors)){
         $p_id= remove_junk($db->escape($_POST['id_edit']));
          ...
          $sql = "UPDATE contacto SET preanalisis_excel='2' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Validado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
...
if(isset($_POST['preanalisis_x_excel'])) {
	...
	if(empty($errors)){
		 ...
		 $p_notas= remove_junk($db->escape($_POST['notas']));
          ...
          $sql = "UPDATE contacto SET preanalisis_excel='3', preanalisis_excel_notas='{$p_notas}' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Descartado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
	...
	if(empty($errors)){
         $p_id= remove_junk($db->escape($_POST['id_edit']));
          ...
          $sql = "UPDATE contacto SET presta_serv='2' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Validado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
...
if(isset($_POST['presta_serv_x'])) {
	...
	if(empty($errors)){
		 ...
		 $p_notas= remove_junk($db->escape($_POST['notas']));
          ...
          $sql = "UPDATE contacto SET presta_serv='3', presta_serv_notas='{$p_notas}' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Descartado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
	...
	if(empty($errors)){
         $p_id= remove_junk($db->escape($_POST['id_edit']));
          ...
          $sql = "UPDATE contacto SET propuesta='2' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Validado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
...
if(isset($_POST['propuesta_x'])) {
	...
	if(empty($errors)){
		 ...
		 $p_notas= remove_junk($db->escape($_POST['notas']));
          ...
          $sql = "UPDATE contacto SET propuesta='3', propuesta_notas='{$p_notas}' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Descartado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
	...
	if(empty($errors)){
         $p_id= remove_junk($db->escape($_POST['id_edit']));
          ...
          $sql = "UPDATE contacto SET cumplimiento='2' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Validado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
...
if(isset($_POST['cumplimiento_x'])) {
	...
	if(empty($errors)){
		 ...
		 $p_notas= remove_junk($db->escape($_POST['notas']));
          ...
          $sql = "UPDATE contacto SET cumplimiento='3', cumplimiento_notas='{$p_notas}' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Descartado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
	...
	if(empty($errors)){
         $p_id= remove_junk($db->escape($_POST['id_edit']));
          ...
          $sql = "UPDATE contacto SET tarifario='2' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Validado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
...
if(isset($_POST['tarifario_x'])) {
	...
	if(empty($errors)){
		 ...
		 $p_notas= remove_junk($db->escape($_POST['notas']));
          ...
          $sql = "UPDATE contacto SET tarifario='3', tarifario_notas='{$p_notas}' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Descartado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
...
if(isset($_POST['tarifario_excel'])) {
	...
	if(empty($errors)){
         $p_id= remove_junk($db->escape($_POST['id_edit']));
          ...
          $sql = "UPDATE contacto SET tarifario_excel='2' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Validado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
...
if(isset($_POST['tarifario_x_excel'])) {
	...
	if(empty($errors)){
		 ...
		 $p_notas= remove_junk($db->escape($_POST['notas']));
          ...
          $sql = "UPDATE contacto SET tarifario_excel='3', tarfario_excel_notas='{$p_notas}' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Descartado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
...
if(isset($_POST['biis'])) {
	...
	if(empty($errors)){
         $p_id= remove_junk($db->escape($_POST['id_edit']));
          ...
          $sql = "UPDATE contacto SET user_biis='2' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Validado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
...
if(isset($_POST['biisx'])) {
	...
	if(empty($errors)){
		 ...
		 $p_notas= remove_junk($db->escape($_POST['notas']));
          ...
          $sql = "UPDATE contacto SET user_biis='3', biis_notas='{$p_notas}' WHERE id='{$p_id}'";
       $result = $db->query($sql);
        if($result && $db->affected_rows() === 1){
          $session->msg('s',"Se ha Descartado el Documento. ");
          echo '<meta http-equiv="Refresh" content="0; url=detalle_documento.php?id='.(int)$p_id.'">';
...
<?php foreach ($products as  $product): ?>    
  ...
  <button class="tablinks" onclick="openCity(event, 'oficial')">Identificación Oficial</button>
			...
			<?php
				...
				<button type="submit" name="alta_envi" class="btn btn-success" title="Aceptar" data-toggle="tooltip"><i class="glyphicon glyphicon-ok" ></i></button>
					...
					<button type="submit" name="alta_envi_x" class="btn btn-danger" title="Rechazar" data-toggle="tooltip"><i class="glyphicon glyphicon-remove" ></i></button>
		  ...
		  <div id="alta_excel" class="tabcontent">
			<?php
				...
				<button type="submit" name="alta_envi_excel" class="btn btn-success" title="Aceptar" data-toggle="tooltip"><i class="glyphicon glyphicon-ok" ></i></button>
					...
					<input type="text" name="notas" class="notas" placeholder="Agrega Notas de Rechazo" >
					<button type="submit" name="alta_envi_x_excel" class="btn btn-danger" title="Rechazar" data-toggle="tooltip"><i class="glyphicon glyphicon-remove" ></i></button>
  ...
  <div id="acta" class="tabcontent">  
	  	...
	  	<?php
				...
				<button type="submit" name="acta_constitutiva" class="btn btn-success" title="Aceptar" data-toggle="tooltip"><i class="glyphicon glyphicon-ok" ></i></button>
				...
				<input type="text" name="notas" class="notas" placeholder="Agrega Notas de Rechazo" >
					...
					<button type="submit" name="acta_constitutiva_x" class="btn btn-danger" title="Rechazar" data-toggle="tooltip"><i class="glyphicon glyphicon-remove" ></i></button>
					</form>
			</div>
			...
			<div id="fiscal" class="tabcontent">
				...
				<button type="submit" name="sit_fiscar" class="btn btn-success" title="Aceptar" data-toggle="tooltip"><i class="glyphicon glyphicon-ok" ></i></button>
				...
				<input type="text" name="notas" class="notas" placeholder="Agrega Notas de Rechazo" >
					...
					<button type="submit" name="sit_fiscar_x" class="btn btn-danger" title="Rechazar" data-toggle="tooltip"><i class="glyphicon glyphicon-remove" ></i></button>
					</form>
			</div>
    ...
    <div id="oficial" class="tabcontent">
				...
				<button type="submit" name="identificacion" class="btn btn-success" title="Aceptar" data-toggle="tooltip"><i class="glyphicon glyphicon-ok" ></i></button>
				...
				<input type="text" name="notas" class="notas" placeholder="Agrega Notas de Rechazo" >
					...
					<button type="submit" name="identificacion_x" class="btn btn-danger" title="Rechazar" data-toggle="tooltip"><i class="glyphicon glyphicon-remove" ></i></button>
					</form>
			</div>
			...
			<div id="domicilio" class="tabcontent">
				...
				<button type="submit" name="comp_domicilio" class="btn btn-success" title="Aceptar" data-toggle="tooltip"><i class="glyphicon glyphicon-ok" ></i></button>
				...
				<input type="text" name="notas" class="notas" placeholder="Agrega Notas de Rechazo" >
					...
					<button type="submit" name="comp_domicilio_x" class="btn btn-danger" title="Rechazar" data-toggle="tooltip"><i class="glyphicon glyphicon-remove" ></i></button>
					</form>
			</div>
      ...
      <div id="cuenta" class="tabcontent">
		  	...
		  	<?php
				...
				<button type="submit" name="estado_cuenta" class="btn btn-success" title="Aceptar" data-toggle="tooltip"><i class="glyphicon glyphicon-ok" ></i></button>
					...
					<input type="text" name="notas" class="notas" placeholder="Agrega Notas de Rechazo" >
					<button type="submit" name="estado_cuenta_x" class="btn btn-danger" title="Rechazar" data-toggle="tooltip"><i class="glyphicon glyphicon-remove" ></i></button>
					</form>
			</div>
			...
			<div id="pre-analisis" class="tabcontent">
		  	...
		  	<?php
				...
				<button type="submit" name="preanalisis" class="btn btn-success" title="Aceptar" data-toggle="tooltip"><i class="glyphicon glyphicon-ok" ></i></button>
				...
				<input type="text" name="notas" class="notas" placeholder="Agrega Notas de Rechazo" >
					...
					<button type="submit" name="preanalisis_x" class="btn btn-danger" title="Rechazar" data-toggle="tooltip"><i class="glyphicon glyphicon-remove" ></i></button>
					</form>
			</div>
			...
			<?php } ?>
		  	...
		  	<?php
				...
				<button type="submit" name="preanalisis_excel" class="btn btn-success" title="Aceptar" data-toggle="tooltip"><i class="glyphicon glyphicon-ok" ></i></button>
				...
				<input type="text" name="notas" class="notas" placeholder="Agrega Notas de Rechazo" >
					...
					<button type="submit" name="preanalisis_x_excel" class="btn btn-danger" title="Rechazar" data-toggle="tooltip"><i class="glyphicon glyphicon-remove" ></i></button>
					</form>
			</div>
		...
		<div id="prestacion" class="tabcontent">
		  	...
		  	<?php
				...
				<button type="submit" name="presta_serv" class="btn btn-success" title="Aceptar" data-toggle="tooltip"><i class="glyphicon glyphicon-ok" ></i></button>
					...
					<input type="text" name="notas" class="notas" placeholder="Agrega Notas de Rechazo" >
					<button type="submit" name="presta_serv_x" class="btn btn-danger" title="Rechazar" data-toggle="tooltip"><i class="glyphicon glyphicon-remove" ></i></button>
					</form>
			</div>
			...
			<div id="propuesta" class="tabcontent">
		  	...
		  	<?php
				...
				<button type="submit" name="propuesta" class="btn btn-success" title="Aceptar" data-toggle="tooltip"><i class="glyphicon glyphicon-ok" ></i></button>
				...
				<input type="text" name="notas" class="notas" placeholder="Agrega Notas de Rechazo" >
					...
					<button type="submit" name="propuesta_x" class="btn btn-danger" title="Rechazar" data-toggle="tooltip"><i class="glyphicon glyphicon-remove" ></i></button>
					</form>
			</div>
			...
			<div id="cumplimiento" class="tabcontent">
		  	...
		  	<?php
				...
				<button type="submit" name="cumplimiento" class="btn btn-success" title="Aceptar" data-toggle="tooltip"><i class="glyphicon glyphicon-ok" ></i></button>
				...
				<input type="text" name="notas" class="notas" placeholder="Agrega Notas de Rechazo" >
					...
					<button type="submit" name="cumplimiento_x" class="btn btn-danger" title="Rechazar" data-toggle="tooltip"><i class="glyphicon glyphicon-remove" ></i></button>
					</form>
			</div>
		  ...
		  <div id="tarifario" class="tabcontent">
		  	...
		  	<?php
				...
				<button type="submit" name="tarifario" class="btn btn-success" title="Aceptar" data-toggle="tooltip"><i class="glyphicon glyphicon-ok" ></i></button>
					...
					<input type="text" name="notas" class="notas" placeholder="Agrega Notas de Rechazo" >
					<button type="submit" name="tarifario_x" class="btn btn-danger" title="Rechazar" data-toggle="tooltip"><i class="glyphicon glyphicon-remove" ></i></button>
					</form>
			</div>
		  ...
		  <div id="tarifario_excel" class="tabcontent">
		  	...
		  	<?php
				...
				<button type="submit" name="tarifario_excel" class="btn btn-success" title="Aceptar" data-toggle="tooltip"><i class="glyphicon glyphicon-ok" ></i></button>
				...
				<input type="text" name="notas" class="notas" placeholder="Agrega Notas de Rechazo" >
					...
					<button type="submit" name="tarifario_x_excel" class="btn btn-danger" title="Rechazar" data-toggle="tooltip"><i class="glyphicon glyphicon-remove" ></i></button>
					</form>
			</div>
