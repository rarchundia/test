		...
		<?php
			...
			<?php 	endforeach; ?>
			  ...
			  foreach ($envia_notificacion as $notificacion):
			   $id_memo=$notificacion['id'];
			
			   $destinatario = $notificacion["correo"]; 
			   $tipo="Nuevo Memo";
    ...
    <table bgcolor="#e0e0e0" cellpadding="0" cellspacing="0" border="0" height="100%" width="100%" style="border-collapse:collapse;">
      <tr>
        <td><center style="width: 100%;">
            ...
            <div style="display:none;font-size:1px;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;font-family: sans-serif;"> Encuesta Envipaq </div>
            ...
            <tr>
                <td style="padding: 40px; text-align: center; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555;"><h3>Recordatorio.<br>Por favor ayudanos a contestar una peque&ntilde;a encuesta que nos ayudara a brindarte un mejor servicio.</h3><br>
                <br>
                
                
                <table cellspacing="0" cellpadding="0" border="0" align="center" style="margin: auto">
                    <tr>
                    <td style="border-radius: 3px; background: #F93A3D; text-align: center;" class="button-td"><a href="http://sci.envipaq.com.mx/login/encuesta.php?id='.$id_memo.'" style="background: #F93A3D; border: 15px solid #F93A3D; padding: 0 10px;color: #ffffff; font-family: sans-serif; font-size: 13px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a"> 
                      <!--[if mso]>&nbsp;&nbsp;&nbsp;&nbsp;<![endif]-->Realizar Encuesta<!--[if mso]>&nbsp;&nbsp;&nbsp;&nbsp;<![endif]--> 
                      </a></td>
                  </tr>
                  </table>
...
$headers .= "From: Encuesta Envipaq <encuesta@envipaq.com.mx>\r\n"; 
...
$envio= mail($destinatario,$asunto,$cuerpo,$headers);
	 ...
	 $memo_update_envio="UPDATE correos_clientes SET enviado='1', fecha_envio='{$date}'  WHERE id='{$id_memo}'";
