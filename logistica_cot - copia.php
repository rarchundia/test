  ...
  //$razonsocial_des = remove_junk($db->escape($_POST['razonsocial_des']));
   ...
   if(empty($errors)){
	...
	$p_id_user = remove_junk($db->escape($_POST['id_user']));
     ...
     $query .=" cliente, tel, correo, servicio, empresa, tipo_mercancia, valor_mercancia, fraccion_arancelaria, id_user, fecha_creacion ";
     $query .=") VALUES (";
$query .="'{$p_cliente}','{$p_tel}','{$p_correo}','{$p_servicio}','{$p_empresa}','{$p_tipo_mercancia}','{$p_valor_mercancia}','{$p_fraccion_arancelaria}','{$p_id_user}','{$date}'";
     $query .=")";
...
<div id="nuevo_ticket" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <input type="tel" class="form-control"  name="tel" placeholder="Teléfono" onkeyup="mayus(this);" >
      ...
      <label for="inputState">Servicio</label><br>
                  ...
                  <div class="col-md-6">
                  <div class="boxes">
  <input type="checkbox" name="servicio[]" id="box-1" value="aduana">
  <label for="box-1">Aduana</label>

  <input type="checkbox" name="servicio[]" value="bodega" id="box-2">
  <label for="box-2">Bodega </label>

  <input type="checkbox" name="servicio[]" value="tramite" id="box-3">
  <label for="box-3">Tramite</label>
                  ...
                  <div class="col-md-6">
                  <div class="boxes">
  <input type="checkbox" name="servicio[]" id="box-4" value="aereo">
  <label for="box-4">Flete Aereo</label>

  <input type="checkbox" name="servicio[]" id="box-5"  value="terrestre">
  <label for="box-5">Flete Terrestre </label>

  <input type="checkbox" name="servicio[]" id="box-6" value="maritimo">
 ...
 <span class="badge alert-danger"><?php  echo $tickets_todos["contador_cotizaciones"];?></span>
	  </a>
 ...
 <span class="badge alert-info"><?php  echo $tickets_resueltos["contador_aceptdas"];?></span>
	  </a>
 ...
 <span class="badge alert-info"> <i class="glyphicon glyphicon-thumbs-down"></i>
 ...
 <span class="badge alert-info"> <i class="glyphicon glyphicon-signal"></i>
	...
	<h4><span class="pull-right"><?php echo    $sin_r['correo'];?><br><?php echo    $sin_r['tel'];?></span></h4>
          <h4>
          Detalles<br>
         
        
              Servicios Requeridos:  <?php echo    $sin_r['servicio'];?><br>
...
echo get_format($diff);
	...
	<h2>En desarrollo no aceptadas</h2>
	...
	<h2>en desarrollo estadisticas</h2>
    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Neque, eveniet earum. Sed accusantium eligendi molestiae quo hic velit nobis et, tempora placeat ratione rem blanditiis voluptates vel ipsam? Facilis, earum!</p>
