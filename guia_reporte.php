...
if(empty($errors)){
	...
	$query  = " UPDATE entrega SET estatus ='50', fecha_factura='{$date}' WHERE id='{$p_id}'";
        ...
        <div class="panel-heading">
          <strong>
            ...
            <span>Guias Envipaq </span>
			  ...
			  <a href="guia_historico.php" class="btn btn-info pull-right btn-sm"> Historico</a>
          </strong>
              ...
              <tr>
				...
				<td class="text-center"><strong><br><br><strong><?php echo remove_junk($product['nombre']);?> </strong></td><!--RAZON SOCIAL-->
				  ...
				  <td class="text-center">
					 <br><br> <strong><?php echo remove_junk($product['quien_genera']);?> </strong>
						  
						 </td>
				  
				  <td class="text-center"> <br><br><strong><?php echo remove_junk($product['fecha']);?> </strong>
				...
				<strong> Carga:</strong> <?php echo remove_junk($product['carga']); ?> / <br>
                 ...
                 <td class="text-center">
					 ...
					 if($product['estatus']==1){
						  ...
						  echo "<br><i class='glyphicon glyphicon-ok' style='color: green;'></i>";
					  }
					 
					 if($product['estatus']==50){
						  
						  echo "<br>Guia Ya Facturada";
					  }
					 ...
					 if($product['estatus']==55){
						  ...
						  echo "<br><i class='glyphicon glyphicon-ban-circle' style='color: purple;' title='Recoleccion en Falso con Cobro' data-toggle='tooltip'> Recoleccion en Falso con Cobro</i>
						  ";
					  }
					 
					 if($product['estatus']==99){
						  
						  echo "<br>Guia Ya Se Encuentra Cancelada";
					  }
				  ...
				  <td>
				  <form action="guia_reporte.php" method="post">
    <input type="hidden" class="form-control" name="id" value="<?php echo remove_junk($product['id']);?>" > 
			  
			<!--<div style="margin-bottom: 25px" class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-usd"></i></span>
                                        <input type="number" class="form-control" name="precio" step='0.01' value="" placeholder=" Agrega un Precio">                                        
                                    </div>-->
			  ...
			  <center><button type="submit" class="btn btn-success" name="precio_btn">Facturar</button></center>
</form>
					  
					  
					<!-- <button type="button" class="btn btn-info" data-toggle="modal" data-target="#<?php echo remove_junk($product['id']);?>">Facturar</button>


<div id="<?php echo remove_junk($product['id']);?>" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Facturar Guia: <?php echo remove_junk($product['id']);?>
			<br> Cliente: <?php echo remove_junk($product['nombre']);?> </h4>
      </div>
    ...
    <input type="hidden" class="form-control" name="id" value="<?php echo remove_junk($product['id']);?>" > 
			...
			<div style="margin-bottom: 25px" class="input-group">
			  ...
			  <center><button type="submit" class="btn btn-success" name="precio_btn">Agregar</button></center>
</form>
...
$("table").tableExport({
	...
	fileName: "Guias_Envipaq_a_facturar",    //Nombre del archivo 
