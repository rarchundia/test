...
<div class="row">
   ...
   <form method="post"  class="dropzone" action="sube_documentos_ajax.php" id="form_constitutiva" enctype="multipart/form-data">
    <input type="hidden" name="correo" id="correo" value="<?php echo $user["email"]?>">
     ...
     <input type="hidden" name="empresa9" id="empresa9" value="<?php echo $id_varible; ?>" >
	  ...
	  --><br><br><br>
		...
		<?php $url=$_SERVER['HTTP_REFERER']; 
			...
			<?php
							...
							?>
			<a href="propuesta.php?id=<?php echo (int)$id_varible; ?>" class="btn btn-primary" id="btn_siguiente">Siguiente &raquo;</a>
    ...
    formData.append("empresa9", jQuery('#empresa9').val()); // attach dropzone image element
...
*/
    ...
    dictDefaultMessage: "Arrastra El Archivo Aqui o Da Click.<br>-Documento Convenio-",
			maxFilesize: 10, // MB
                maxFiles: 1,
			addRemoveLinks: true,
