<?php
  $page_title = 'Propuesta Comercial';
...
<div class="row">
   ...
   <form method="post"  class="dropzone" action="sube_documentos_ajax.php" id="form_constitutiva" enctype="multipart/form-data">
    <input type="hidden" name="correo" id="correo" value="<?php echo $user["email"]?>">
     ...
     <input type="hidden" name="empresa10" id="empresa10" value="<?php echo $id_varible; ?>" >
	  ...
	  --><br><br><br>
			...
			<?php
							...
							?>
			<a href="tarifario.php?id=<?php echo (int)$id_varible; ?>" class="btn btn-primary" id="btn_siguiente">Siguiente &raquo;</a>
    ...
    formData.append("empresa10", jQuery('#empresa10').val()); // attach dropzone image element
...
*/
    ...
    dictDefaultMessage: "Arrastra El Archivo Aqui o Da Click.<br>-Documento Propuesta Comercial-",
			maxFilesize: 10, // MB
                maxFiles: 1,
			addRemoveLinks: true,
