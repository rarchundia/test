<?php
  $page_title = 'Opinión de Cumplimiento';
...
<div class="row">
   ...
   <form method="post"  class="dropzone" action="sube_documentos_ajax.php" id="form_constitutiva" enctype="multipart/form-data">
     ...
     <input type="hidden" name="empresa3" id="empresa3" value="<?php echo $id_varible; ?>" >
    ...
    formData.append("empresa3", jQuery('#empresa3').val()); // attach dropzone image element
...
*/
    ...
    dictDefaultMessage: "Arrastra El Archivo Aqui o Da Click.<br>-Documento Opinión de Cumplimiento-",
			maxFilesize: 10, // MB
                maxFiles: 1,
			addRemoveLinks: true,
