...
<div id="envipaq" class="tabcontent">
  <form method="post" action="entrega.php" class="clearfix">
   ...
   <p> <center><h2>DESTINATARIO</h2></center>
           ...
           <button type="reset" class="btn btn-danger">Limpiar</button> <button type="submit" name="programa" class="btn btn-success">Programar Entrega</button>
...
<input id="arancelaria_btn" type="checkbox"/><label for="switch">Clasificación Arancelaria.</label> 	  
		...
		<p><center>
		 ...
		 <button type="submit" name="aduana" class="btn btn-success">Generar Pedimento</button>
					  </center></p>
  ...
  <form method="post" action="entrega.php" class="clearfix">
             ...
             <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="input-group">
                  ...
                  <input type="number" class="form-control" name="palet" placeholder="# de Palet´s"  >
               </div></div>
               <br><br><br>
		...
		<br><br><br>
					  <center> <button type="reset" class="btn btn-danger">limpiar</button>
		 <button type="submit" name="almacen" class="btn btn-success">Generar Pedimento</button>
					  </center>
					  </form>
		</div>
	...
	<form method="post" action="entrega.php" class="clearfix">
         ...
         <br><br><br>
                ...
                <div class="col-md-12">
				 ...
				 <center>
				 <button type="reset" class="btn btn-danger">Limpiar</button>
		 <button type="submit" name="cotizar" class="btn btn-success">Registrar  Pedimento</button>
					  </center>
		</div></form>	
		</div><!--fin cotizar-->
