...
toastr.{$key}('".remove_junk(first_character($value))."');
...
toastr.".$key."('".remove_junk(first_character($value))."',\" Notificación \");
...
/*$output  = "<br><div class=\"alert alert-{$key}\" >";
