  ...
  <div class="col-md-6">
     <div class="panel panel-default">
       <div class="panel-heading">
          ...
          Actualiza cuenta <strong><?php echo remove_junk(ucwords($e_user['name'])); ?>
        </strong>
       </div>
       <div class="panel-body">
		   
				
		<center> <img src="uploads/users/<?php echo $e_user['image']; ?>" alt="image" class="img-circle img-inline" height="120px" width="130px">
		   </center>
  ...
  <div class="col-md-6">
    <div class="panel panel-default">
      <div class="panel-heading">
          ...
          <span class="glyphicon glyphicon-user"></span>
          Recetear pasword de  <strong><?php echo remove_junk(ucwords($e_user['name'])); ?> contraseña
        </strong>
      </div>
      <div class="panel-body">
