...
Puedes subir los archivos juntos  o uno por uno
   ...
   <form method="post"  class="dropzone" action="sube_documentos_ajax.php" id="form_constitutiva" enctype="multipart/form-data">
    <input type="hidden" name="correo" id="correo" value="<?php echo $user["email"]?>">
     ...
     <input type="hidden" name="empresa12" id="empresa12" value="<?php echo $id_varible; ?>" >
	  ...
	  --><br><br><br>
			...
			<?php
							...
							?>
			<a href="biis.php?id=<?php echo (int)$id_varible; ?>" class="btn btn-primary" id="btn_siguiente">Siguiente &raquo;</a>
    ...
    formData.append("empresa12", jQuery('#empresa12').val()); // attach dropzone image element
...
*/
    ...
    dictDefaultMessage: "Arrastra El Archivo Aqui o Da Click.<br>-Documento  Tarifario Excel-",
			maxFilesize: 10, // MB
                maxFiles: 2,
			addRemoveLinks: true,
