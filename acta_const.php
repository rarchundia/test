      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <strong>
            ...
            <span>Acta Constitutiva <sub>(opcional)</sub> </span>
          </strong>
        </div>
...
<form method="post"  class="dropzone" action="sube_documentos_ajax.php" id="form_constitutiva" enctype="multipart/form-data">
     ...
     <input type="hidden" name="empresa11" id="empresa11" value="<?php echo $id_varible; ?>" >
	 <!--   <input type="text" name="empresa" id="empresa" value="<?php echo $id_varible; ?>" >
	-->  <br><br><br>
	...
	<?php $url=$_SERVER['HTTP_REFERER']; 
			...
			<?php
							...
							?>
			<form action="detalle_contacto.php?id=<?php echo (int)$id_varible ?>" method="post">
				<input type="hidden" name="empresa_acta" id="empresa_acta" value="<?php echo $id_varible; ?>" >
			
				
				
				<button type="submit" id="btn_siguiente" name="finaliza" class="btn btn-primary">     Siguiente    </button>
    ...
    formData.append("empresa11", jQuery('#empresa11').val()); // attach dropzone image element
...
*/
    ...
    dictDefaultMessage: "Arrastra El Archivo Aqui o Da Click.<br>-Documento Acta Constitutiva-",
			maxFilesize: 10, // MB
                maxFiles: 1,
			addRemoveLinks: true,
